"""Run half-duplex Omni chat inference without Memory."""
...
def main() -> None:
    ...
    output_path = OUTPUT_DIR / "offline_chat.wav"
    ...
    frames, audios, _ = get_video_frame_audio_segments(str(video_path), stack_frames=1)
    content = []
